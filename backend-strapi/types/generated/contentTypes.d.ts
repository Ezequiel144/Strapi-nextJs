...
export interface ApiPlatfromPlatfrom extends Schema.CollectionType {
  ...
  attributes: {
    ...
    company: Attribute.Enumeration<
      ['SONY', 'playstation', 'nintengo', 'microsoft', 'SNK']
    >;
    launch: Attribute.Date & Attribute.Required;
    video_games: Attribute.Relation<
      'api::platfrom.platfrom',
      'manyToMany',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::platfrom.platfrom': ApiPlatfromPlatfrom;
